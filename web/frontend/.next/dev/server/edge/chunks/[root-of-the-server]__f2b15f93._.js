...
function middleware(req) {
    ...
    const onboarding = req.cookies.get("onboarding_done")?.value;
    const url = req.nextUrl.clone();
    const path = url.pathname;
    const isAuthPage = path.startsWith("/login") || path.startsWith("/signup");
    // 1️⃣ Si pas connecté → rediriger vers /login
    if (!token && !isAuthPage) {
        url.pathname = "/login";
    ...
    // 2️⃣ Si connecté mais onboarding non fait → forcer /onboarding
    if (token && !onboarding && path !== "/onboarding") {
        url.pathname = "/onboarding";
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url);
    }
    // 3️⃣ Si connecté + onboarding fait → accès normal
