      ...
      <div className="relative flex h-full flex-col justify-between">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="mt-1.5 flex items-center justify-center gap-1.5">
            ...
            <span className="flex h-8 w-8 items-center justify-center rounded-lg border-2 border-emerald-200/50 bg-gradient-to-br from-emerald-400/25 to-cyan-400/15 font-black text-emerald-50 shadow-lg shadow-emerald-500/20">
              {node.value}
            </span>
          </div>
        </div>
        ...
        <div className="mt-2 text-[8px] text-slate-300 group-hover:text-white transition-colors">
          {selected ? "Sélectionné" : "Cliquer / glisser"}
        </div>
      </div>
    </motion.div>
  );
